# Projet-Wakdo-Malick-BAWakdo – Borne de commande & Back-office
Présentation Projet
Le projet a été réalisé pour la certification RNCP 37805 – Développeur Web.
Il consiste à concevoir une solution de digitalisation pour un fast-food (Wakdo), inspiré du fonctionnement des bornes de commande modernes.
L’application permetttra aux clients de passer commande de manière autonome via une borne tactile, puis de récupérer leur commande au comptoir grâce à un numéro unique.
...
Front borne (Bloc 1) : interface client (HTML, CSS, JavaScript)
Back-office & API (Bloc 2) : gestion des données (Node.js, Express, MySQL)
Application React (Bloc 3) : recherche de restaurants sur carte (React + Vite)
